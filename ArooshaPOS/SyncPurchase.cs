...
namespace ArooshaPOS
{
    ...
    public class SyncPurchase
    {
        ...
        public List<PosTypeItem> GetPosType()
        {
            List<PosTypeItem> posList = new List<PosTypeItem>();

            PosTypeItem item = new PosTypeItem();
            item.PosType = "AAP";
            item.PosTypeName = "آپ";
            posList.Add(item);

            item = new PosTypeItem();
            item.PosType = "Shahr_PAX_S80_S90";
            item.PosTypeName = "بانک شهر";
            posList.Add(item);

            item = new PosTypeItem();
            item.PosType = "Saderat_AMP_KICE";
            item.PosTypeName = "بانک صادرات";
            posList.Add(item);

            item = new PosTypeItem();
            item.PosType = "SamanKish_SSP1126";
            item.PosTypeName = "بانک سامان";
            posList.Add(item);

            item = new PosTypeItem();
            item.PosType = "BehPardakht_WinService";
            item.PosTypeName = "بانک ملت (سرویس)";
            posList.Add(item);

            item = new PosTypeItem();
            item.PosType = "BehPardakht_AMP7000";
            item.PosTypeName = "بانک ملت (کتابخانه)";
            posList.Add(item);

            item = new PosTypeItem();
            item.PosType = "Sadad_BlueBird_S3500";
            item.PosTypeName = "بانک ملی";
            posList.Add(item);
