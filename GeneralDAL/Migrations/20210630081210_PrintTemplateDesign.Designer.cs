...
namespace GeneralDAL.Migrations
{
    ...
    [Migration("20210630081210_PrintTemplateDesign")]
    partial class PrintTemplateDesign
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GeneralDAL.Database.Attendance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GeneralDAL.Database.Customer", b =>
                {
                    ...
                    b.Property<int?>("AppAccountBalance")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("TotalPaymentsAmount")
                        .HasColumnType("int");

                    b.Property<int?>("TotalRentsAmount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GeneralDAL.Database.Discount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GeneralDAL.Database.MenuItem", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 35,
                            ActionName = "PrintTemplate",
                            CategoryId = 2,
                            Code = "PrintTemplate",
                            ControllerName = "General",
                            DialogSize = "medium",
                            Name = "تعریف فرمت رسید اجاره و رزرو",
                            Priority = 8,
                            ShowInMenu = true
                        },
                        new
                        {
                            Id = 36,
                            ActionName = "PrintTemplateDesign",
                            CategoryId = 2,
                            Code = "PrintTemplateDesign",
                            ControllerName = "General",
                            DialogSize = "large",
                            Name = "طراحی فرمت رسید اجاره و رزرو",
                            Priority = 9,
                            ShowInMenu = false
                        });
                });

            modelBuilder.Entity("GeneralDAL.Database.PCPosSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("ResponceTimeout")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("TerminalSerialID")
                        .HasColumnType("nvarchar(50)")
                        .HasMaxLength(50);

                    b.HasKey("Id");

                    b.ToTable("PCPosSetting","Gnr");
                });
            ...
            modelBuilder.Entity("GeneralDAL.Database.Person", b =>
                {
                    ...
                    b.HasAlternateKey("Code")
                        .HasName("AK_Person_Code");

                    b.HasAlternateKey("StrCode")
                        .HasName("AK_Person_StrCode");
            ...
            modelBuilder.Entity("GeneralDAL.Database.PrintTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PrintTemplate","Gnr");
                });

            modelBuilder.Entity("GeneralDAL.Database.PrinterSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GeneralDAL.Database.SMSMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("SMSMessageText")
                    ...
                    b.ToTable("SMSMessage","Gnr");
                });

            modelBuilder.Entity("GeneralDAL.Database.SMSTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("SMSTemplate","Gnr");
                });

            modelBuilder.Entity("GeneralDAL.Database.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GeneralDAL.Database.Customer", b =>
                {
                    b.HasOne("GeneralDAL.Database.Region", "BirthCity")
                        .WithMany()
                        .HasForeignKey("BirthCityId");

                    b.HasOne("GeneralDAL.Database.Region", "IssuanceCity")
                        .WithMany()
                        .HasForeignKey("IssuanceCityId");

                    b.HasOne("GeneralDAL.Database.JobGroup", "JobGroup")
                        .WithMany("Customers")
                        .HasForeignKey("JobGroupId");

                    b.HasOne("GeneralDAL.Database.Job", "Job")
                        .WithMany()
                        .HasForeignKey("JobId");
                });
            ...
            modelBuilder.Entity("GeneralDAL.Database.Rent", b =>
                {
                    ...
                    b.HasOne("GeneralDAL.Database.Discount", "Discount")
                        .WithMany("Rents")
                    ...
                    b.HasOne("GeneralDAL.Database.Tariff", "Tariff")
                        .WithMany("Rents")
            ...
            modelBuilder.Entity("GeneralDAL.Database.SMSMessage", b =>
                {
                    b.HasOne("GeneralDAL.Database.SMSTemplate", "SMSTemplate")
